    ...
    <<
        ...
        {
              %! +SCORE
            \once \override Score.NonMusicalPaperColumn.line-break-system-details = #'((alignment-distances . (0 18 40 20)))
            \time 6/8
            s1 * 3/4
              %! +SCORE
            - \tweak padding #24
            ...
            \break
              %! +SCORE
            \once \override Score.NonMusicalPaperColumn.line-break-system-details = #'((alignment-distances . (0 18.5 40 22)))
            \once \override Score.TimeSignature.stencil = ##f
            \time 6/8
            s1 * 3/4
              %! +SCORE
            ...
            \break
              %! +SCORE
            \once \override Score.NonMusicalPaperColumn.line-break-system-details = #'((alignment-distances . (2 19.5 30 21)))
            \time 7/16
            s1 * 7/16
            ^ \markup \override #'(font-name . "Bodoni72 Book") { \hspace #2.5 \raise #14 \with-dimensions-from \null \concat { \fontsize #0.5 { \note { 8 } #2 } \fontsize #8 { "= 84" } } }
              %! +SCORE
            \noBreak
            \once \override Score.TimeSignature.stencil = ##f
            \time 7/16
            ...
            \noPageBreak
              %! +SCORE
            \once \override Score.NonMusicalPaperColumn.line-break-system-details = #'((alignment-distances . (0 18 12)))
            \time 2/8
            s1 * 1/4
                        ...
                        \tag #'voice1
                        {
                            \context disappearingStaff = "cello 1 staff"
                            {
                                \context Voice = "cello 1 voice"
                                {
                                    ...
                                    - \tweak font-name "Bodoni72 Book Italic" 
                                    - \tweak font-size 2
                                    _ \markup { \raise #-4.5 { \hspace #1 \column { \line { "Solo" } \line { "Con fuoco" } \line { Con licenza } } } }
                                    \times 2/3
                                    {
                                        \afterGrace
                                        g'8
                            ...
                            \context Staff = "guitar 2 staff"
                            {
                                \context Voice = "guitar 2 voice"
                                {
                                    ...
                                    \times 6/7
                                    {
                                        ...
                                        <a, cs>8.
                                        \override Dots.staff-position = #2
                                        \once \override Staff.Clef.X-extent = #'(-1.5 . 2.5)
                                        \clef "treble"
                                        \revert Staff.Stem.stemlet-length
                                        <e a cs' fs'>8
                                        ]
